...
export class EventoDetalheComponent implements OnInit {
  // form: FormGroup = this.formBuilder.group({});  //TODO : aula 114 nos comentários
  ...
  confirmDeleteLote(): void {
    ...
    this.loteService
      ...
      .subscribe(
        ...
        (error: any) => {
          this.toastr.error(
            `Erro ao tentar ecluir o lote ${this.loteAtual.id}`,
            'Erro!'
          );
          console.error(error);
        }
  ...
  uploadImagem(): void {
    ...
    this.eventoService
      ...
      .subscribe(
        ...
        (error: any) => {
          this.toastr.error('Falha ao carregar a imagem!', 'Error!');
          console.log(error);
        }
      )
      .add(() => this.spinner.hide());
